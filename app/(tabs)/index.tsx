...
import { Alert, ScrollView, SectionList, StatusBar, StyleSheet, Text, View } from 'react-native'
...
const DateSectionHeader = ({
    ...
    const totalText =
        total.income > 0 ? `收: ${total.income.toFixed(2)}` : `支: ${total.expense.toFixed(2)}`

    return (
        <View className="flex-row justify-between items-center bg-transparent px-4 py-2 mt-4 dark:border-gray-800">
            <Text className="text-sm font-medium text-gray-400 dark:text-gray-300">{title}</Text>
