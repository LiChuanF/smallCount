...
export default function StatsScreen() {
    ...
    const { filter, chartData, isLoading, setFilter, loadStatsData, comparisonData } =
        useStatsStore()
                ...
                >
                    ...
                    <View className="items-center mb-6">
                        ...
                        <View className="flex-row items-center bg-red-100 dark:bg-red-900/20 px-2 py-0.5 rounded text-xs">
                            <Text
                                className={`text-[10px] mr-1 ${comparisonData && comparisonData.percentageChange > 0 ? 'text-red-500' : 'text-green-500'}`}
                            >
                                {comparisonData
