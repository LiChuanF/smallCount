...
// 自定义日期组件
const CustomDay = ({ date, state, onPress, onLongPress, theme, transactionsData, isDark }: any) => {
...
export default function CalendarWidget({
    ...
    const [internalSelectedDates, setInternalSelectedDates] = useState<Set<string>>(
