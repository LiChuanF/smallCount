        ...
        >
            <TouchableWithoutFeedback onPress={onClose}>
                <View
                    ...
                    style={{ backgroundColor: themeColors.bgOverlay }}
                >
                    <TouchableWithoutFeedback>
                        <View
                            className="rounded-t-xl pb-safe w-full"
                            style={{ backgroundColor: themeColors.bgModal }}
                        >
                            <View className="p-6">
                                {/* 1. 顶部操作栏 (取消/标题/确定) */}
                                ...
                                <View className="flex-row justify-between items-center mb-6 px-4">
                                    <TouchableOpacity
                                        onPress={
                                            isPrevButtonEnabled() ? handleHeaderPrev : undefined
                                        }
                                        className="p-2"
                                        hitSlop={10}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {/* 如果在月份模式，加个小图标提示可点击 */}
                                            {mode === 'month' && (
                                                <Text className="text-md ml-1 text-gray-500 dark:text-gray-400">
                                                    ▼
                                                </Text>
                                            )}
                                        </View>
                                    ...
                                    <TouchableOpacity
                                        onPress={
                                            isNextButtonEnabled() ? handleHeaderNext : undefined
                                        }
                                        className="p-2"
                                        hitSlop={10}
                                    ...
                                    {mode === 'month'
                                        ? // --- 月份渲染 ---
                                          months.map(month => {
                                              ...
                                              const isDisabled = !isMonthAllowed(
                                                  selectedYear,
                                                  month,
                                              )
                                              return (
                                                  <TouchableOpacity
                                                      key={month}
                                                      onPress={() =>
                                                          !isDisabled && setSelectedMonth(month)
                                                      }
